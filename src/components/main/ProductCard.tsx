...
const ProductCard: React.FC<ProductProps> = ({product}) => {
  return (
    <div key={product.id} className="relative bg-dark-black border border-dark-gold p-4 rounded-lg group overflow-hidden">
    ...
    <Link to={`/products/${product.id}`} className="w-full flex justify-center cursor-pointer z-10">
    <Button
